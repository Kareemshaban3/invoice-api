...
class UpdateInvoiceRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'representatives_id' => ['sometimes', 'nullable', 'integer', 'exists:representatives,id'],
            'branches_id' => ['sometimes', 'nullable', 'integer', 'exists:branches,id'],
            ...
            'items.*.item_type' => ['required_with:items', Rule::in(['product', 'service'])],
